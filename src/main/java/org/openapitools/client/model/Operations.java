      ...
      if (jsonObj.get("linkGroups") != null && !jsonObj.get("linkGroups").isJsonNull()) {
        ...
        if (jsonArraylinkGroups != null) {
          ...
          if (!jsonObj.get("linkGroups").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `linkGroups` to be an array in the JSON string but got `%s`", jsonObj.get("linkGroups").toString()));
          }
