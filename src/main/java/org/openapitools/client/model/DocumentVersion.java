  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DocumentVersion is not found in the empty JSON string", DocumentVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (String requiredField : DocumentVersion.openapiRequiredFields) {
