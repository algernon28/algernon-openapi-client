  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JiraMultipleGroupPickerField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JiraMultipleGroupPickerField is not found in the empty JSON string", JiraMultipleGroupPickerField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JiraMultipleGroupPickerField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JiraMultipleGroupPickerField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
