...
public class JiraRichTextField {
  ...
  static {
    ...
    openapiRequiredFields.add("richText");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JiraRichTextField.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JiraRichTextField is not found in the empty JSON string", JiraRichTextField.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!JiraRichTextField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JiraRichTextField` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
