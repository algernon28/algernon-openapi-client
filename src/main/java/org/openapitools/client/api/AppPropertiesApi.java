...
public class AppPropertiesApi {
     ...
     */
    public okhttp3.Call deleteForgeAppPropertyCall(String propertyKey, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteForgeAppPropertyValidateBeforeCall(String propertyKey, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'propertyKey' is set
        if (propertyKey == null) {
     ...
     */
    public okhttp3.Call deleteForgeAppPropertyAsync(String propertyKey, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putForgeAppPropertyCall(String propertyKey, Object body, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call putForgeAppPropertyValidateBeforeCall(String propertyKey, Object body, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'propertyKey' is set
        if (propertyKey == null) {
     ...
     */
    public OperationMessage putForgeAppProperty(String propertyKey, Object body) throws ApiException {
     ...
     */
    public ApiResponse<OperationMessage> putForgeAppPropertyWithHttpInfo(String propertyKey, Object body) throws ApiException {
     ...
     */
    public okhttp3.Call putForgeAppPropertyAsync(String propertyKey, Object body, final ApiCallback<OperationMessage> _callback) throws ApiException {
