...
public class IssueCustomFieldOptionsApi {
     ...
     */
    public okhttp3.Call replaceCustomFieldOptionCall(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceCustomFieldOptionValidateBeforeCall(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fieldId' is set
        if (fieldId == null) {
     ...
     */
    public okhttp3.Call replaceCustomFieldOptionAsync(String fieldId, Long optionId, Long contextId, Long replaceWith, String jql, final ApiCallback<Void> _callback) throws ApiException {
