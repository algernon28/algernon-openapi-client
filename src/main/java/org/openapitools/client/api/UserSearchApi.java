...
public class UserSearchApi {
     ...
     */
    public okhttp3.Call findUserKeysByQueryCall(String query, Long startAt, Integer maxResult, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findUserKeysByQueryValidateBeforeCall(String query, Long startAt, Integer maxResult, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call findUserKeysByQueryAsync(String query, Long startAt, Integer maxResult, final ApiCallback<PageBeanUserKey> _callback) throws ApiException {
