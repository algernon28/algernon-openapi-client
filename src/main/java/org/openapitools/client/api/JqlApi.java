...
public class JqlApi {
     ...
     */
    public okhttp3.Call parseJqlQueriesCall(String validation, JqlQueriesToParse jqlQueriesToParse, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call parseJqlQueriesValidateBeforeCall(String validation, JqlQueriesToParse jqlQueriesToParse, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ParsedJqlQueries parseJqlQueries(String validation, JqlQueriesToParse jqlQueriesToParse) throws ApiException {
     ...
     */
    public ApiResponse<ParsedJqlQueries> parseJqlQueriesWithHttpInfo(String validation, JqlQueriesToParse jqlQueriesToParse) throws ApiException {
     ...
     */
    public okhttp3.Call parseJqlQueriesAsync(String validation, JqlQueriesToParse jqlQueriesToParse, final ApiCallback<ParsedJqlQueries> _callback) throws ApiException {
