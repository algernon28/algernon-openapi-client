...
public class ProjectVersionsApi {
     ...
     */
    public okhttp3.Call createRelatedWorkCall(String id, VersionRelatedWork versionRelatedWork, final ApiCallback _callback) throws ApiException {
     ...
     */
    public VersionRelatedWork createRelatedWork(String id, VersionRelatedWork versionRelatedWork) throws ApiException {
     ...
     */
    public ApiResponse<VersionRelatedWork> createRelatedWorkWithHttpInfo(String id, VersionRelatedWork versionRelatedWork) throws ApiException {
     ...
     */
    public okhttp3.Call createRelatedWorkAsync(String id, VersionRelatedWork versionRelatedWork, final ApiCallback<VersionRelatedWork> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call deleteRelatedWorkCall(String versionId, String relatedWorkId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public okhttp3.Call deleteRelatedWorkAsync(String versionId, String relatedWorkId, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getRelatedWorkCall(String id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRelatedWorkValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
     ...
     */
    public okhttp3.Call getRelatedWorkAsync(String id, final ApiCallback<List<VersionRelatedWork>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateRelatedWorkCall(String id, VersionRelatedWork versionRelatedWork, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
     ...
     */
    public VersionRelatedWork updateRelatedWork(String id, VersionRelatedWork versionRelatedWork) throws ApiException {
     ...
     */
    public ApiResponse<VersionRelatedWork> updateRelatedWorkWithHttpInfo(String id, VersionRelatedWork versionRelatedWork) throws ApiException {
     ...
     */
    public okhttp3.Call updateRelatedWorkAsync(String id, VersionRelatedWork versionRelatedWork, final ApiCallback<VersionRelatedWork> _callback) throws ApiException {
