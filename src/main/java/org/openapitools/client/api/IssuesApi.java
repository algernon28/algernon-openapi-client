...
import org.openapitools.client.model.ArchiveIssueAsyncRequest;
import org.openapitools.client.model.ArchivedIssuesFilterRequest;
...
import org.openapitools.client.model.ExportArchivedIssuesTaskProgressResponse;
import org.openapitools.client.model.IssueArchivalSyncRequest;
import org.openapitools.client.model.IssueArchivalSyncResponse;
...
import org.openapitools.client.model.IssueLimitReportRequest;
import org.openapitools.client.model.IssueLimitReportResponseBean;
...
import org.openapitools.client.model.PageOfCreateMetaIssueTypeWithField;
import org.openapitools.client.model.PageOfCreateMetaIssueTypes;
...
public class IssuesApi {
     ...
     * @param issueLimitReportRequest  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Returned if the request is successful. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Returned if the request is invalid. Other possible reasons:   *  the field queried is not supported  *  the threshold is not within the supported range </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Returned if the authentication credentials are incorrect or missing. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Returned if the user does not have permission to complete this request. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getIssueLimitReportCall(IssueLimitReportRequest issueLimitReportRequest, Boolean isReturningKeys, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = issueLimitReportRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getIssueLimitReportValidateBeforeCall(IssueLimitReportRequest issueLimitReportRequest, Boolean isReturningKeys, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'issueLimitReportRequest' is set
        if (issueLimitReportRequest == null) {
            throw new ApiException("Missing the required parameter 'issueLimitReportRequest' when calling getIssueLimitReport(Async)");
        }

        return getIssueLimitReportCall(issueLimitReportRequest, isReturningKeys, _callback);
     ...
     */
    public IssueLimitReportResponseBean getIssueLimitReport(IssueLimitReportRequest issueLimitReportRequest, Boolean isReturningKeys) throws ApiException {
        ApiResponse<IssueLimitReportResponseBean> localVarResp = getIssueLimitReportWithHttpInfo(issueLimitReportRequest, isReturningKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<IssueLimitReportResponseBean> getIssueLimitReportWithHttpInfo(IssueLimitReportRequest issueLimitReportRequest, Boolean isReturningKeys) throws ApiException {
        okhttp3.Call localVarCall = getIssueLimitReportValidateBeforeCall(issueLimitReportRequest, isReturningKeys, null);
     ...
     */
    public okhttp3.Call getIssueLimitReportAsync(IssueLimitReportRequest issueLimitReportRequest, Boolean isReturningKeys, final ApiCallback<IssueLimitReportResponseBean> _callback) throws ApiException {

        okhttp3.Call localVarCall = getIssueLimitReportValidateBeforeCall(issueLimitReportRequest, isReturningKeys, _callback);
        Type localVarReturnType = new TypeToken<IssueLimitReportResponseBean>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
