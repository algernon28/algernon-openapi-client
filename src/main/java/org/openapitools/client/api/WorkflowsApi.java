...
import org.openapitools.client.model.WorkflowCapabilities;
import org.openapitools.client.model.WorkflowCreateRequest;
import org.openapitools.client.model.WorkflowCreateResponse;
import org.openapitools.client.model.WorkflowCreateValidateRequest;
import org.openapitools.client.model.WorkflowIDs;
import org.openapitools.client.model.WorkflowReadRequest;
import org.openapitools.client.model.WorkflowReadResponse;
import org.openapitools.client.model.WorkflowUpdateRequest;
import org.openapitools.client.model.WorkflowUpdateResponse;
import org.openapitools.client.model.WorkflowUpdateValidateRequestBean;
import org.openapitools.client.model.WorkflowValidationErrorList;
...
public class WorkflowsApi {
     ...
     * @param useTransitionLinksFormat Return the new fields (&#x60;toStatusReference&#x60;/&#x60;links&#x60;) instead of the deprecated fields (&#x60;to&#x60;/&#x60;from&#x60;) for workflow transition port mappings. (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call readWorkflowsCall(WorkflowReadRequest workflowReadRequest, String expand, Boolean useTransitionLinksFormat, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (useTransitionLinksFormat != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("useTransitionLinksFormat", useTransitionLinksFormat));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call readWorkflowsValidateBeforeCall(WorkflowReadRequest workflowReadRequest, String expand, Boolean useTransitionLinksFormat, final ApiCallback _callback) throws ApiException {
        ...
        return readWorkflowsCall(workflowReadRequest, expand, useTransitionLinksFormat, _callback);
     ...
     */
    public WorkflowReadResponse readWorkflows(WorkflowReadRequest workflowReadRequest, String expand, Boolean useTransitionLinksFormat) throws ApiException {
        ApiResponse<WorkflowReadResponse> localVarResp = readWorkflowsWithHttpInfo(workflowReadRequest, expand, useTransitionLinksFormat);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WorkflowReadResponse> readWorkflowsWithHttpInfo(WorkflowReadRequest workflowReadRequest, String expand, Boolean useTransitionLinksFormat) throws ApiException {
        okhttp3.Call localVarCall = readWorkflowsValidateBeforeCall(workflowReadRequest, expand, useTransitionLinksFormat, null);
     ...
     */
    public okhttp3.Call readWorkflowsAsync(WorkflowReadRequest workflowReadRequest, String expand, Boolean useTransitionLinksFormat, final ApiCallback<WorkflowReadResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = readWorkflowsValidateBeforeCall(workflowReadRequest, expand, useTransitionLinksFormat, _callback);
        Type localVarReturnType = new TypeToken<WorkflowReadResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
