...
<a id="getCreateIssueMetaIssueTypeId"></a>
...
<a id="getCreateIssueMetaIssueTypes"></a>
...
<a id="getIssueLimitReport"></a>
# **getIssueLimitReport**
> IssueLimitReportResponseBean getIssueLimitReport(issueLimitReportRequest, isReturningKeys)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      IssueLimitReportResponseBean result = apiInstance.getIssueLimitReport(issueLimitReportRequest, isReturningKeys);
      System.out.println(result);
    } catch (ApiException e) {
